...
use CodersLab\ShopBundle\Form\PhotoType;
...
class PhotoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CodersLabShopBundle:Photo')->findAll();
     ...
     * @Method("POST")
     * @Template("CodersLabShopBundle:Photo:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CodersLabShopBundle:Photo')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("CodersLabShopBundle:Photo:edit.html.twig")
     */
